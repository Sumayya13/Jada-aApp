...
public class googlePay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // note.setText("donation");
        ...
        amount.setText( " "+extras.getString("pPrice"));
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    Toast.makeText(googlePay.this,"Fill all above details and try again.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(googlePay.this,"Google pay is not installed. Please istall and try again.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(googlePay.this, "Transaction successful. "+approvalRefNo, Toast.LENGTH_SHORT).show();
